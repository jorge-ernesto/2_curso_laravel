...
@section('seccion-scripts')
    @if( session('mensaje_rollback') || $errors->any() )
        <script>
            $('#cargarDetalle').append(Cookies.get('cookiedetalle'));
        </script>
    @endif
    ...
    <script>
        ...
        function cookiedetalle() {
            ...
            /* Cookie detalle */
            cookie_detalle = $('#cargarDetalle').html();
            Cookies.set('cookiedetalle', cookie_detalle, { expires: 7 });
            // console.log(Cookies.get('cookiedetalle'));
        }
    </script>
@endsection